...
ClosedHands knows its own capabilities and can configure itself. Try:
...
## Teach ClosedHands your project: AGENTS.md

Drop an `AGENTS.md` file in your repo root with build commands, conventions,
and gotchas. ClosedHands reads it automatically in every session — it's the single
...
## Teach ClosedHands your facts: memory
