...
Fear not — your settings, rules, and skills come with you. ClosedHands
...
writes the items you selected into your `.closedhands` config. Re-run it anytime.
...
Run **`closedhands inspect`** in a repo to see every rules file, skill, and MCP
server ClosedHands picked up, tagged with where it came from. Each compat source
