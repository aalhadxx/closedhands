...
Customize and extend ClosedHands.
...
Automate, script, and integrate ClosedHands with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `closedhands -p`, output formats, CI/CD integration, and piping |
