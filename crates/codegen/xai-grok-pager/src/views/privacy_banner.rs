...
const PRIVACY_BANNER_TITLE: &str = "Help improve ClosedHands";

const PRIVACY_BANNER_DESC: &str = "Off by default. Opt-in to allow the project maintainers to retain coding \
     data, e.g., prompts, traces, & metrics, for training and debugging purposes. Change \
     anytime via settings.";

pub(crate) const PRIVACY_BANNER_TERMS_URL: &str = "https://github.com/aalhadxx/closedhands";
pub(crate) const PRIVACY_BANNER_POLICY_URL: &str = "https://github.com/aalhadxx/closedhands";
